...
function TableCell(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)("td", __assign({ "data-slot": "table-cell", className: (0, utils_1.cn)("p-2 align-middle text-primary-foreground whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]", className) }, props)));
}
