...
function Card(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ "data-slot": "card", className: (0, utils_1.cn)("dark:bg-secondary bg-muted text-card-foreground flex flex-col gap-6 rounded-lg border py-6 shadow-sm", className) }, props)));
}
...
function CardTitle(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)("div", __assign({ "data-slot": "card-title", className: (0, utils_1.cn)("leading-none text-primary-foreground font-semibold", className) }, props)));
}
function CardDescription(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)("div", __assign({ "data-slot": "card-description", className: (0, utils_1.cn)("text-primary-foreground text-sm", className) }, props)));
}
